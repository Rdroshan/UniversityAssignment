...
urlpatterns = [
    ...
    path(
        "student/<pk>/classes/",
        student_views.get_student_classes,
        name="get_student_classes",
    ),
    path(
        "student/<pk>/performance/",
        student_views.get_student_performance,
        name="get_student_performance",
    ),
    path(
        "student/<student_id>/class/<class_id>/",
        student_views.get_student_class_details,
        name="get_student_class_details",
    ),
    # class apis
    ...
    path(
        "class/<pk>/performance/",
        class_views.get_class_performance,
        name="get_class_performance",
    ),
    path(
        "class/<pk>/final-grade-sheet/",
        class_views.get_final_grade_sheet,
        name="get_final_grade_sheet",
    ),
    path(
        "class/<class_id>/student/<student_id>/",
        class_views.get_student_class_details,
        name="get_class_student_details",
    ),
]
